      ...
      >
        ...
        <div className="fixed top-0 inset-x-0 z-[110] p-5 flex items-center justify-between text-white bg-gradient-to-b from-black/80 via-black/40 to-transparent">
          ...
          <div className="flex flex-col items-center">
            <span className="text-[10px] font-black uppercase tracking-[4px] opacity-60 mb-1">Sales Feed</span>
    ...
    <div className="min-h-screen bg-surface-primary">
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
           <div>
              <h2 className="text-xl font-black text-content-primary">Social Grid</h2>
