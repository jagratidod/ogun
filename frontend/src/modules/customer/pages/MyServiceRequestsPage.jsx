   ...
   return (
      <div className="page-container flex flex-col gap-6 max-w-lg mx-auto">
            ...
            {myRequests.length === 0 ? (
               ...
               >
                  <div className="p-4 flex items-center gap-4">
                     ...
                     <div className="flex items-center justify-center w-8 h-8 rounded-none bg-white border border-border group-hover:bg-brand-pink group-hover:text-white transition-all">
         ...
         <div className="pb-8 space-y-4">
            <div className="flex items-center justify-center gap-3 p-4 rounded-none bg-white border border-border opacity-60">
