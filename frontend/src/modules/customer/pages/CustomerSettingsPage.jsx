  ...
  return (
    <div className="page-container max-w-lg mx-auto flex flex-col gap-6">
      ...
      <div className="flex items-center gap-6 p-6 glass-card border-brand-teal/20 animate-slide-up">
         <Avatar name="Rahul Verma" size="lg" className="border-2 border-brand-teal ring-4 ring-brand-teal/5 shadow-glow" />
         <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mt-3 cursor-pointer group" onClick={() => toast.info('Request received. Our team will review your eligibility.')}>
        ...
        <div className="space-y-4">
           {activeTab?.label === 'Identity Information' && (
              <>
                 ...
                 <Input label="Contact Email" defaultValue="rahul.v@gmail.com" />
