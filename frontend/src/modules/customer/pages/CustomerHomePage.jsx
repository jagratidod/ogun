...
import { RiVerifiedBadgeLine, RiPriceTag3Line, RiTrophyLine, RiInformationLine, RiAddCircleLine, RiQuestionLine, RiSmartphoneLine, RiHeartLine, RiShoppingBasketLine, RiCustomerServiceLine, RiArrowRightSLine, RiShieldStarLine } from 'react-icons/ri';
import { Badge, Button, Avatar, Card, CardHeader, CardTitle, CardDescription } from '../../../core';
  ...
  return (
    <div className="page-container flex flex-col gap-6 max-w-lg mx-auto">
         ...
         <div className="space-y-3">
            {products.map(prod => (
               <div 
                 ...
                 className="p-4 rounded-none bg-surface-elevated border border-border flex items-center gap-4 group active:bg-surface-elevated/80 transition-all cursor-pointer"
               >
                  <div className="w-12 h-12 rounded-none bg-surface-primary flex items-center justify-center text-brand-teal group-hover:bg-brand-teal/10 transition-colors">
      ...
      <Card className="bg-surface-elevated/50 border-dashed border-2">
         <div className="p-6 flex items-center gap-6">
            ...
            <div className="flex-1">
               ...
               <div className="w-full h-1 bg-surface-primary overflow-hidden rounded-none mt-3">
      ...
      <div className="pb-8 space-y-4">
         <div className="flex items-center justify-center gap-3 p-4 rounded-none border border-border opacity-50">
            <RiInformationLine className="w-4 h-4 text-brand-teal" />
            <p className="text-[10px] font-medium text-center">Need more help? Our 24/7 service desk is at your disposal.</p>
         </div>
      </div>
    </div>
  );
