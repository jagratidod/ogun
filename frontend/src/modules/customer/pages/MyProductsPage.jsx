         ...
         {products.map(prod => (
           ...
           >
              <div className="p-4 flex items-center gap-4">
                 ...
                 <div className="flex items-center justify-center w-8 h-8 rounded-none bg-surface-primary border border-border group-hover:bg-brand-teal group-hover:text-white transition-all">
